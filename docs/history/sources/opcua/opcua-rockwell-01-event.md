# sources/opcua/opcua-rockwell-01-event.json — history and reasoning

Moved verbatim out of `sources/opcua/opcua-rockwell-01-event.json`, where each field now holds its first sentence. The JSON says what a thing is; this file keeps why it became that.
